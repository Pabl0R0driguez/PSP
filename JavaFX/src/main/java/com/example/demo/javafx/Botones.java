...
public class Botones extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imagen = new Image("file:resources/images/messi.jpg", 60, 60, true, true);
            btTextoImagen.setGraphic(new ImageView(imagen));
                btTextoImagen.setText("Messi");
            btTextoImagen.setGraphicTextGap(20);
            btTextoImagen.setFont(Font.font("Ani", 20));

            Image imagen1 = new Image("file:resources/images/fali.jpg", 100, 100, true, true);
            btImagen.setGraphic(new ImageView(imagen1));
